...
First create a database in SSMS, using a new query and typing: CREATE DATABASE MovingData, and execute that. Then in Object Explorer find your database
(refresh Object Explorer if you can't find it) press right-click --> Tasks --> Import data. For Data source choose 'Flat File source', and press 'Browse...'
Beside the file name (right bottom corner) choose CSV files, and find files where you saved them. Next --> Next. For Destination, choose 'SQL Server Native Client 11.0'
